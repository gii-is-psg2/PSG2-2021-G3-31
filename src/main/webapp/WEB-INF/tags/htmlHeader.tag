...
<%--
PetClinic :: una demostración del Framework Spring
--%>
...
<head>
    ...
    <spring:url value="/resources/images/favicon3.png" var="favicon"/>
    <link rel="shortcut icon" type="image/x-icon" href="${favicon}">

    <title>PetClinic :: una demostración del Framework Spring</title>
